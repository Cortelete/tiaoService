...
import type { User, UserCredentials, UserStatus, ServiceRequest, ServiceRequestStatus, JobPost, ActiveModal } from './types';
...
type View = 'home' | 'professionals' | 'admin' | 'profile' | 'opportunities';
